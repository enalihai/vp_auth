...
RSpec.describe 'User Movies View Parties New page' do
  describe 'creation form', :vcr do
    before :each do
      @user = User.create!(name: 'Peter Cushing', email: 'helsing@hammer.com', password: 'password', password_confirmation: 'password')
      @user2 = User.create!(name: 'Christopher Lee', email: 'dracula@hammer.com', password: 'password', password_confirmation: 'password')
      @user3 = User.create!(name: 'Bela Lugosi', email: 'dracula@universal.com', password: 'password', password_confirmation: 'password')
